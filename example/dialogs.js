...
// Here we implement default dialogs for link and image editing
// There are just here for testing, any real usage will require
// UI that is better integrated with the host

function editLink(attrs) {
