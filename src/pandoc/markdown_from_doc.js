...
// from https://github.com/ProseMirror/prosemirror-markdown/blob/master/src/to_markdown.js


// get pandoc markdown from PM doc
export function pandocMarkdownFromDoc(content) {
  return Promise.resolve(pandocMarkdownSerializer.serialize(content));
}
...
const pandocMarkdownSerializer = new MarkdownSerializer({
